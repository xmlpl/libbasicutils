...
public:
  ...
  BasicFileLocation(const std::string filename, const std::string function, const long line, 
		    const long col) : 
...
#define FILE_LOCATION BasicFileLocation(__FILE__, __func__, __LINE__, -1)
